...
public class lab09 {
    ...
    */
        ...
        addButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (result == JOptionPane.OK_OPTION) {
                    addDriver(name, experience, category);
                }
            }
        });
        ...
        editButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRow != -1) {
                    ...
                    JTextField nameField = new JTextField((String) tableModel.getValueAt(selectedRow, 0), 20);
                    JTextField experienceField = new JTextField((String) tableModel.getValueAt(selectedRow, 1), 20);
                    JTextField categoryField = new JTextField((String) tableModel.getValueAt(selectedRow, 2), 20);
                    ...
                    if (result == JOptionPane.OK_OPTION) {
                        editDriver(selectedRow, name, experience, category);
                    }
    ...
    public void addDriver(String name, String experience, String category) {
        if (name != null && !name.isEmpty() && experience != null && !experience.isEmpty() && category != null && !category.isEmpty()) {
    ...
    public void editDriver(int row, String name, String experience, String category) {
        if (name != null && !name.isEmpty() && experience != null && !experience.isEmpty() && category != null && !category.isEmpty()) {
    ...
    public void deleteDriver(int selectedRow) {
        if (selectedRow != -1) {
